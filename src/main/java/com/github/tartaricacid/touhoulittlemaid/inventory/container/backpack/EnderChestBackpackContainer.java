...
public class EnderChestBackpackContainer extends MaidMainContainer {
    public static final MenuType<EnderChestBackpackContainer> TYPE = new ExtendedScreenHandlerType<>(
            (id, inv, data) -> new EnderChestBackpackContainer(id, inv, data.readInt())
    );
