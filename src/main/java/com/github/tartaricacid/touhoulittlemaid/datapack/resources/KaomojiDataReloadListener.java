...
public class KaomojiDataReloadListener implements ResourceManagerReloadListener, IdentifiableResourceReloadListener {
    private static final ResourceLocation FILE_PATH = new ResourceLocation(TouhouLittleMaid.MOD_ID, "chat_bubble/kaomoji.json");
    private static final Gson GSON = new Gson();

    private static final ResourceLocation ID = new ResourceLocation(TouhouLittleMaid.MOD_ID, "kaomoji_reload");
